...
module.exports = {
  ...
  plugins: ["eslint-plugin-prefer-arrow", "jsdoc", "@typescript-eslint", "ban"],
  rules: {
    "ban/ban": [
      "error",
      { name: ["describe", "only"], message: "don't use only" },
      { name: ["context", "only"], message: "don't use only" },
      { name: ["it", "only"], message: "don't use only" }
    ],
